...
export const GUI_REN: Record<string, [string, string]> = raw.guiRen as unknown as Record<string, [string, string]> // [阳贵, 阴贵]
...
export const TIANJIANG_JIXIONG: Record<string, '吉' | '凶' | '中'> = raw.tianjiangJixiong as Record<string, '吉' | '凶' | '中'>
