...
const xiaoliurenReq: DivineRequest = {
  ...
  raw: { palm: "留连", auspicious: "凶", meaning: "卒未归时，五行属水，黑色，主事难成，宜缓不宜急", numerology: { month: 3, day: 18, hour: 7 } },
  steps: [
    { key: "yue", title: "一、大安起月", desc: "从大安起正月，顺数 3 个月，落速喜。", data: { landed: "速喜" } },
    { key: "ri", title: "二、月上起日", desc: "从速喜宫起初一，顺数 18 天，落留连。", data: { landed: "留连" } },
    { key: "shi", title: "三、日上起时", desc: "从留连宫起子时，顺数 7 个时辰，落留连。", data: { landed: "留连" } },
  ],
  question: "看感情",
  season: "四季",
};
